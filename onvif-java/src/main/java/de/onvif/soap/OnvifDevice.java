...
public class OnvifDevice {
  ...
  public ArrayList<String> getStreamUris(){
    ArrayList<String> streamUris = new ArrayList<String>();
    for ( int i=0; i< media.getProfiles().size(); i++)
      streamUris.add(getStreamUri(i));
    return streamUris;
  }
  ...
  public String getDeviceCodec(){
    return media.getVideoEncoderConfigurations().get(0).getEncoding().toString();
  }
